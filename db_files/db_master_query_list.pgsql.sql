...
drop schema if exists "data_imports" cascade;
create schema "data_imports";
...
*	Country List
******************************************************************/
drop table if exists "supplements"."countries" cascade;
create table "supplements"."countries" (
...
create index supplements_countries_2code_idx ON supplements.countries ("2code");
create index supplements_countries_3code_idx ON supplements.countries ("3code");


insert into "supplements"."countries" ("id","2code","3code","title","active") values
(0,'','','',false),
(1,'AX','ALA','Åland Islands',false),
(2,'AF','AFG','Afghanistan',true),
(3,'AL','ALB','Albania',true),
(4,'DZ','DZA','Algeria',true),
(5,'AS','ASM','American Samoa',true),
(6,'AD','AND','Andorra',true),
(7,'AO','AGO','Angola',true),
(8,'AI','AIA','Anguilla',true),
(9,'AQ','ATA','Antarctica',true),
(10,'AG','ATG','Antigua And Barbuda',true),
(11,'AR','ARG','Argentina',true),
(12,'AM','ARM','Armenia',true),
(13,'AW','ABW','Aruba',true),
(14,'AU','AUS','Australia',true),
(15,'AT','AUT','Austria',true),
(16,'AZ','AZE','Azerbaijan',true),
(17,'BS','BHS','Bahamas',true),
(18,'BH','BHR','Bahrain',true),
(19,'BD','BGD','Bangladesh',true),
(20,'BB','BRB','Barbados',true),
(21,'BY','BLR','Belarus',true),
(22,'BE','BEL','Belgium',true),
(23,'BZ','BLZ','Belize',true),
(24,'BJ','BEN','Benin',true),
(25,'BM','BMU','Bermuda',true),
(26,'BT','BTN','Bhutan',true),
(27,'BO','BOL','Bolivia',true),
(28,'BA','BIH','Bosnia And Herzegovina',true),
(29,'BW','BWA','Botswana',true),
(30,'BV','BVT','Bouvet Island',true),
(31,'BR','BRA','Brazil',true),
(32,'IO','IOT','British Indian Ocean Territory',false),
(33,'BN','BRN','Brunei Darussalam',true),
(34,'BG','BGR','Bulgaria',true),
(35,'BF','BFA','Burkina Faso',true),
(36,'BI','BDI','Burundi',true),
(37,'CI','CIV',E'Côte d\'Ivoire (Ivory Coast)',false),
(38,'KH','KHM','Cambodia',true),
(39,'CM','CMR','Cameroon',true),
(40,'CA','CAN','Canada',true),
(41,'','','Canary Islands',false),
(42,'CV','CPV','Cape Verde',true),
(43,'KY','CYM','Cayman Islands',true),
(44,'CF','CAF','Central African Republic',true),
(45,'TD','TCD','Chad',true),
(46,'CL','CHL','Chile',true),
(47,'CN','CHN','China',true),
(48,'CX','CXR','Christmas Island',true),
(49,'CC','CCK','Cocos (Keeling) Islands',true),
(50,'CO','COL','Colombia',true),
(51,'KM','COM','Comorian',true),
(52,'CG','COG','Congo, Republic Of',true),
(53,'CD','COD','Congo, The Democratic Republic Of The (Formerly Zaire)',false),
(54,'CK','COK','Cook Islands',true),
(55,'CR','CRI','Costa Rica',true),
(56,'HR','HRV','Croatia',true),
(57,'CU','CUB','Cuba',false),
(58,'CY','CYP','Cyprus',true),
(59,'CZ','CZE','Czech Republic',true),
(60,'DK','DNK','Denmark',true),
(61,'DJ','DJI','Djibouti',true),
(62,'DM','DMA','Dominica',true),
(63,'DO','DOM','Dominican Republic',true),
(64,'','','East Timor',false),
(65,'EC','ECU','Ecuador',true),
(66,'EG','EGY','Egypt',true),
(67,'SV','SLV','El Salvador',true),
(68,'GQ','GNQ','Equatorial Guinea',true),
(69,'ER','ERI','Eritrea',true),
(70,'EE','EST','Estonia',true),
(71,'ET','ETH','Ethiopia',true),
(72,'FO','FRO','Faroe Islands',true),
(73,'FK','FLK','Falkland Islands (Malvinas)',true),
(74,'FJ','FJI','Fiji',true),
(75,'FI','FIN','Finland',true),
(76,'FR','FRA','France',true),
(77,'GF','GUF','French Guiana',true),
(78,'PF','PYF','French Polynesia',true),
(79,'TF','ATF','French Southern Territories',false),
(80,'GA','GAB','Gabon',true),
(81,'GM','GMB','Gambia',true),
(82,'GE','GEO','Georgia, Republic Of',true),
(83,'DE','DEU','Germany',true),
(84,'GH','GHA','Ghana',true),
(85,'GI','GIB','Gibraltar',true),
(86,'GB','GBR','Great Britain',true),
(87,'GR','GRC','Greece',true),
(88,'GL','GRL','Greenland',true),
(89,'GD','GRD','Grenada',true),
(90,'GP','GLP','Guadeloupe',true),
(91,'GU','GUM','Guam',true),
(92,'GT','GTM','Guatemala',true),
(93,'','','Guernsey',false),
(94,'GN','GIN','Guinea',true),
(95,'GW','GNB','Guinea-Bissau',true),
(96,'GY','GUY','Guyana',true),
(97,'HT','HTI','Haiti',true),
(98,'HM','HMD','Heard And Mc Donald Islands',false),
...
(105,'IR','IRN','Iran (Islamic Republic Of Iran)',false),
(106,'IQ','IRQ','Iraq',true),
(107,'IE','IRL','Ireland',true),
(108,'','','Isle Of Man',false),
...
(118,'KP','PRK',E'Korea, Democratic People\'s Rep',false),
(119,'KR','KOR','Korea, Republic Of',true),
(120,'KW','KWT','Kuwait',true),
(121,'KG','KGZ','Kyrgyzstan',true),
(122,'LA','LAO',E'Lao People\'s Democratic R. Of',true),
(123,'LV','LVA','Latvia',true),
(124,'LB','LBN','Lebanon',true),
(125,'LS','LSO','Lesotho',true),
(126,'LR','LBR','Liberia',true),
(127,'LY','LBY','Libya (Libyan Arab Jamahirya)',true),
(128,'LI','LIE','Liechtenstein',true),
(129,'LT','LTU','Lithuania',true),
(130,'LU','LUX','Luxembourg',true),
(131,'MO','MAC','Macau',true),
(132,'MK','MKD','Macedonia',true),
(133,'MG','MDG','Madagascar',true),
(134,'MW','MWI','Malawi',true),
(135,'MY','MYS','Malaysia',true),
(136,'MV','MDV','Maldives',true),
(137,'ML','MLI','Mali',true),
(138,'MT','MLT','Malta',true),
(139,'MH','MHL','Marshall Islands',true),
(140,'MQ','MTQ','Martinique',true),
(141,'MR','MRT','Mauritania',true),
(142,'MU','MUS','Mauritius',true),
(143,'YT','MYT','Mayotte',true),
(144,'MX','MEX','Mexico',true),
(145,'FM','FSM','Micronesia',true),
(146,'MD','MDA','Moldova, Republic Of',true),
(147,'MC','MCO','Monaco',true),
(148,'MN','MNG','Mongolia',true),
(149,'MS','MSR','Montserrat',true),
(150,'MA','MAR','Morocco',true),
(151,'MZ','MOZ','Mozambique',true),
(152,'MM','MMR','Myanmar',false),
(153,'NA','NAM','Namibia',true),
(154,'NR','NRU','Nauru',true),
(155,'NP','NPL','Nepal',true),
(156,'NL','NLD','Netherlands',true),
(157,'AN','ANT','Netherlands Antilles',true),
(158,'NC','NCL','New Caledonia',true),
(159,'NZ','NZL','New Zealand',true),
(160,'NI','NIC','Nicaragua',true),
(161,'NE','NER','Niger',true),
(162,'NG','NGA','Nigeria',true),
(163,'NU','NIU','Niue',true),
(164,'NF','NFK','Norfolk Island',true),
(165,'MP','MNP','Northern Mariana Islands',true),
(166,'NO','NOR','Norway',true),
(167,'OM','OMN','Oman',true),
(168,'PK','PAK','Pakistan',true),
(169,'PW','PLW','Palau',true),
(170,'PS','PSE','Palestinian Territory',false),
(171,'PA','PAN','Panama',true),
(172,'PG','PNG','Papua New Guinea',true),
(173,'PY','PRY','Paraguay',true),
(174,'PE','PER','Peru',true),
(175,'PH','PHL','Philippines',true),
(176,'PN','PCN','Pitcairn',true),
(177,'PL','POL','Poland',true),
(178,'PT','PRT','Portugal',true),
(179,'PR','PRI','Puerto Rico',true),
(180,'QA','QAT','Qatar',true),
(181,'RE','REU','Reunion',false),
(182,'RO','ROU','Romania',true),
(183,'RU','RUS','Russia',true),
(184,'RW','RWA','Rwanda',true),
(185,'SH','SHN','Saint Helena',true),
(186,'','',E'S Georgia & The S Sandwich Islands',false),
(187,'KN','KNA','Saint Kitts And Nevis',true),
(188,'LC','LCA','Saint Lucia',true),
(189,'PM','SPM','Saint Pierre And Miquelon',true),
(190,'VC','VCT','Saint Vincent And The Grenadines',true),
(191,'WS','WSM','Samoa (Formerly Western Samoa)',true),
(192,'SM','SMR','San Marino',true),
(193,'ST','STP','Sao Tome And Principe',true),
(194,'SA','SAU','Saudi Arabia',true),
(195,'','','Scotland',false),
(196,'SN','SEN','Senegal',true),
(197,'CS','SCG','Serbia And Montenegro (Yugoslavia)',true),
(198,'SC','SYC','Seychelles',true),
(199,'SL','SLE','Sierra Leone',true),
(200,'SG','SGP','Singapore',true),
...
(206,'GS','SGS','South Georgia And The South Sandwich Islands',false),
(207,'ES','ESP','Spain',true),
(208,'LK','LKA','Sri Lanka',true),
(209,'','','St. Helena',false),
(210,'SD','SDN','Sudan',false),
(211,'','','St. Pierre And Miquelon',false),
(212,'SR','SUR','Suriname',true),
(213,'SJ','SJM','Svalbard And Jan Mayen Islands',true),
(214,'SZ','SWZ','Swaziland',true),
(215,'SE','SWE','Sweden',true),
(216,'CH','CHE','Switzerland',true),
(217,'SY','SYR','Syrian Arab Republic',false),
(218,'TW','TWN','Taiwan',true),
(219,'TJ','TJK','Tajikistan',true),
(220,'TZ','TZA','Tanzania, United Republic Of',true),
(221,'TH','THA','Thailand',true),
(222,'TL','TLS','Timor-Leste (Formerly East Timor)',true),
(223,'TG','TGO','Togo',true),
(224,'TK','TKL','Tokelau',true),
(225,'TO','TON','Tonga',true),
(226,'TT','TTO','Trinidad And Tobago',true),
(227,'TN','TUN','Tunisia',true),
(228,'TR','TUR','Turkey',true),
(229,'TM','TKM','Turkmenistan',true),
(230,'TC','TCA','Turks And Caicos Islands',true),
(231,'TV','TUV','Tuvalu',true),
(232,'UG','UGA','Uganda',true),
(233,'UA','UKR','Ukraine',true),
(234,'AE','ARE','United Arab Emirates',true),
(235,'GB','GBR','United Kingdom',true),
(236,'US','USA','United States',true),
(237,'UM','UMI','United States Minor Outlying',false),
(238,'UY','URY','Uruguay',true),
(239,'UZ','UZB','Uzbekistan',true),
(240,'VU','VUT','Vanuatu',true),
(241,'VA','VAT','Vatican City State (Holy See)',true),
(242,'VE','VEN','Venezuela',true),
(243,'VN','VNM','Viet Nam',true),
(244,'VG','VGB','Virgin Islands (British)',true),
(245,'VI','VIR','Virgin Islands (U.S.)',true),
(246,'WF','WLF','Wallis And Futuna Islands',true),
(247,'EH','ESH','Western Sahara',true),
(248,'YE','YEM','Yemen',true),
(249,'YU','','Yugoslavia',false),
(250,'ZM','ZMB','Zambia',true),
(251,'ZW','ZWE','Zimbabwe',true),
(252,'','','Curacao',false),
(253,'','','Dutch Antilles',false),
(254,'','','San Salvador',false);

SELECT setval('supplements.countries_id_seq', COALESCE((SELECT MAX(id)+1 FROM supplements.countries), 1), false);

/******************************************************************
*	Security Levels
******************************************************************/
drop table if exists "supplements"."regions" cascade;
create table "supplements"."regions" (
	"id" serial primary key,
	"active" boolean not null default true,
	"country_id" int2 not null default '0' references supplements.countries (id),
	"2code" varchar(3) not null default '',
	"title" varchar(150) not null default '',
	"created" timestamp not null default current_timestamp,
	"modified" timestamp not null default current_timestamp
);
create index supplements_regions_2code_idx ON supplements.regions ("2code");

insert into "supplements"."regions" ("id","active","country_id","title","2code") VALUES
	(0,false,236,'','')
;

SELECT setval('supplements.regions_id_seq', COALESCE((SELECT MAX(id)+1 FROM supplements.regions), 1), false);
insert into "supplements"."regions" ("country_id","title","2code") VALUES 
(236,'Alabama','AL'),
(236,'Alaska','AK'),
(236,'Arizona','AZ'),
(236,'Arkansas','AR'),
...
create table "system"."users" (
	...
	,"region_id" smallint default 0 references supplements.regions (id)
	,"country_id" smallint default 0 references supplements.countries (id)
...
insert into system.users (id,active,firstname,lastname,username,region_id,country_id) values 
	(0,false,'Default User','Default User','default',0,0)
...
drop table if exists "public"."dynamic_content_types" cascade;
CREATE TABLE "public"."dynamic_content_types" (
	"id" serial primary key
	,"active" boolean not null default true
...
insert into "public"."dynamic_content_types" (alias,title,description) values
...
CREATE TABLE "public"."dynamic_content" (
	...
	,"dynamic_content_type_id" smallint default 1 references dynamic_content_types (id)
...
insert into "public"."dynamic_content" (active,alias,title,content) values
	(false,'template','Placeholder Template','Placeholder Template')
;
...
create table "system"."paths" (
	...
	,"dynamic_content_id" int default null references dynamic_content (id)
...
INSERT INTO "system"."paths" (path, module_name, template, title, alias, folder, description, dynamic_variables) VALUES 
	('/', 'landing', 'default', 'GM Tools', 'landing', '', '', '[]')
...
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content/', 'dynamic_content', 'admin', 'Dynamic Content', 'dynamic_content', 'modules/acu/dynamic_content/', '', '[]', '2015-01-30 11:20:15.173797', '2015-01-30 11:20:15.173797');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content/add/', 'dynamic_content_add', 'admin', 'Add Dynamic Content', 'dynamic_content_add', 'modules/acu/dynamic_content/', '', '[]', '2015-01-30 11:20:15.206367', '2015-01-30 11:20:15.206367');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content/edit/', 'dynamic_content_edit', 'admin', 'Edit Dynamic Content', 'dynamic_content_edit', 'modules/acu/dynamic_content/', '', '[]', '2015-01-30 11:20:15.230101', '2015-01-30 11:20:15.230101');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content/audit/', 'dynamic_content_audit', 'admin', 'Audit Dynamic Content', 'dynamic_content_audit', 'modules/acu/dynamic_content/', '', '[]', '2015-01-30 11:20:15.241245', '2015-01-30 11:20:15.241245');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content/delete/', 'dynamic_content_delete', 'admin', 'Delete Dynamic Content', 'dynamic_content_delete', 'modules/acu/dynamic_content/', '', '[]', '2015-01-30 11:20:15.264616', '2015-01-30 11:20:15.264616');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content-type/', 'dynamic_content_type', 'admin', 'Dynamic Content Type', 'dynamic_content_type', 'modules/acu/dynamic_content_type/', '', '[]', '2015-01-30 11:20:22.662564', '2015-01-30 11:20:22.662564');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content-type/add/', 'dynamic_content_type_add', 'admin', 'Add Dynamic Content Type', 'dynamic_content_type_add', 'modules/acu/dynamic_content_type/', '', '[]', '2015-01-30 11:20:22.692943', '2015-01-30 11:20:22.692943');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content-type/edit/', 'dynamic_content_type_edit', 'admin', 'Edit Dynamic Content Type', 'dynamic_content_type_edit', 'modules/acu/dynamic_content_type/', '', '[]', '2015-01-30 11:20:22.709745', '2015-01-30 11:20:22.709745');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content-type/audit/', 'dynamic_content_type_audit', 'admin', 'Audit Dynamic Content Type', 'dynamic_content_type_audit', 'modules/acu/dynamic_content_type/', '', '[]', '2015-01-30 11:20:22.728723', '2015-01-30 11:20:22.728723');
INSERT INTO "system"."paths" (active, is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('t', 'f', '/acu/dynamic-content-type/delete/', 'dynamic_content_type_delete', 'admin', 'Delete Dynamic Content Type', 'dynamic_content_type_delete', 'modules/acu/dynamic_content_type/', '', '[]', '2015-01-30 11:20:22.751224', '2015-01-30 11:20:22.751224');


INSERT INTO "system"."paths" (is_dynamic, "path", module_name, "template", title, "alias", folder, description, dynamic_variables, created, modified) VALUES ('f', '/acu/page-hits/', 'page_hits', 'admin', 'Page Hits', 'page_hits', '', '', '[]', '2015-01-30 11:20:22.751224', '2015-01-30 11:20:22.751224');
...
insert into "system"."paths_ajax" (uid, folder, file, dynamic_variables) values
	...
	,('a9068764f45c45d5799d85488d242fad', 'modules/ajax_files/', 'page_hits_jqgrid.ajax.php', '{"db_schema":"public","db_table":"page_hits"}')

	,('b76ace59e039eb2f0c980e0ec740c19b', 'modules/acu/pages/ajax_files/', 'page.ajax.php', '{}')
	,('33130820a0ec9047527e4bba1b12d55d', 'modules/acu/pages/ajax_files/', 'page_audit.ajax.php', '{"db_schema":"public","db_table":"pages"}')

	,('384b12d1fb0698c55678f879482a9325', 'modules/acu/security_permissions/ajax_files/', 'security_permission.ajax.php', '{"db_schema":"security","db_table":"permissions"}')
	,('7a3c99435bf1e75d6743c6fa88b41554', '', 'audits.ajax.php', '{"db_schema":"security","db_table":"permissions"}')

	,('a8469e90b1d018cede0385f1eb461e3b', 'modules/acu/security_groups/ajax_files/', 'security_group.ajax.php', '{}')
	,('8343bf7e72ed95fa0cb3aceb0bc32fca', '', 'audits.ajax.php', '{"db_schema":"security","db_table":"groups"}')

	,('46a3cfa998267ccbf626eeb4c4b618a4', 'modules/acu/security_sections/ajax_files/', 'security_section.ajax.php', '{}')
	,('17a1fdb1c48e45a596c9332c7bdd7ad3', '', 'audits.ajax.php', '{"db_schema":"security","db_table":"section"}')

	,('a9068764f45c45d5799d85488d242fab', 'modules/acu/security_roles/ajax_files/', 'security_role.ajax.php', '{"db_schema":"security","db_table":"roles"}')
	,('495d34152a71320335c04e96bdeeaed4', '', 'audits.ajax.php', '{"db_schema":"security","db_table":"roles"}')


	,('71395ff031577e3a21b972de5fe6b0a4', 'modules/acu/paths/ajax_files/', 'path.ajax.php', '{"db_schema":"system","db_table":"paths"}')
	,('54c3ba3624df159f3ed9470e5b198f6b', '', 'audits.ajax.php', '{"db_schema":"system","db_table":"paths"}')

	,('02a54624a9ea0058b4ab1b96265afd84', 'modules/acu/users/ajax_files/', 'user.ajax.php', '{"db_schema":"system","db_table":"users"}')
	,('93e7093793b032761370bc46f83e233d', '', 'audits.ajax.php', '{"db_schema":"system","db_table":"users"}')
	...
	,('3d2eb91c6c1a0a150901eaefae479296', 'modules/acu/dynamic_content/ajax_files/', 'dynamic_content.ajax.php', '{"db_schema":"public","db_table":"dynamic_content"}')
	,('5cfcb6280c27ab5981cfce764d3ec91d', '', 'audits.ajax.php', '{"db_schema":"public","db_table":"dynamic_content"}')
	
	,('06a0fc087756944595785e90f79ecad5', 'modules/acu/dynamic_content_type/ajax_files/', 'dynamic_content_type.ajax.php', '{"db_schema":"public","db_table":"dynamic_content_types"}')
	,('05a189b351be980dd51488a1558d322f', '', 'audits.ajax.php', '{"db_schema":"public","db_table":"dynamic_content_types"}')
...
create table "system"."forgot_password" (
	"id" serial primary key
	,"user_id" int not null references system.users (id)
...
insert into "security"."roles" ("title","alias") values 
...
drop table if exists "security"."sections" cascade;
create table "security"."sections" (
	"id" serial primary key
	,"active" boolean not null default true
	,"title" varchar(30) not null default ''
	,"alias" varchar(30) not null default ''
...
insert into "security"."sections" ("id","active","title","alias") VALUES
	(0,false,'Default','default')
;
SELECT setval('security.sections_id_seq', COALESCE((SELECT MAX(id)+1 FROM security.sections), 1), false);

insert into "security"."sections" ("title","alias") values 
	('General','general')
	,('Users','users')
	,('Products','products')
	,('Media','media')
...
insert into "security"."groups" ("id","active","title","alias") VALUES
	(0,false,'Default','default')
;
SELECT setval('security.groups_id_seq', COALESCE((SELECT MAX(id)+1 FROM security.groups), 1), false);

insert into "security"."groups" ("title","alias") values 
	-- users
	...
	,('Dynamic Content Types','dynamic_content_types')
	,('Worlds','worlds')
	,('Themes','themes')
	,('Prizes','prizes')
...
create table "security"."permissions" (
	"id" serial primary key
	,"active" boolean not null default true
	,"section_id" smallint not null default 0 references security.sections (id)
	,"group_id" smallint not null default 0 references security.groups (id)
	,"title" varchar(30) not null default ''
	,"alias" varchar(30) not null default ''
	,"description" varchar not null default ''
	,"created" timestamp default current_timestamp
...
insert into "security"."permissions" ("id","active","title","alias") VALUES
	(0,false,'Default','default')
;
SELECT setval('security.permissions_id_seq', COALESCE((SELECT MAX(id)+1 FROM security.permissions), 1), false);


-- Users -> Roles
drop table if exists "security"."role_user_map" cascade;
create table "security"."role_user_map" (
	"id" serial primary key
	,"role_id" smallint not null default 0 references security.roles (id)
	,"user_id" int not null default 0 references system.users (id)
	,"created" timestamp default current_timestamp
	,"modified" timestamp default current_timestamp
);
insert into security.role_user_map (role_id,user_id) values (5,1); -- Public User

-- Roles -> Permissions
drop table if exists "security"."role_permission_map" cascade;
create table "security"."role_permission_map" (
	"id" serial primary key
	,"role_id" smallint not null default 0 references security.roles (id)
	,"section_id" smallint default 0 references security.sections (id)
	,"group_id" smallint default 0 references security.groups (id)
	,"permission_id" smallint default 0 references security.permissions (id)
	,"created" timestamp default current_timestamp
	,"modified" timestamp default current_timestamp
);


drop table if exists "security"."permission_types" cascade;
create table "security"."permission_types" (
	"id" serial primary key
	,"title" varchar(30) not null default ''
	,"alias" varchar(30) not null default ''
	,"description" varchar not null default ''
...
insert into "security"."permission_types" ("title","alias") values 
	('Allow','allow'),('Deny','deny'),('Ignore','ignore')
;


-- Users -> Permissions (overriding the Role -> Permissions)
drop table if exists "security"."permission_override_map" cascade;
create table "security"."permission_override_map" (
	"id" serial primary key
	,"user_id" int not null default 0 references system.users (id)
	,"section_id" smallint default 0 references security.sections (id)
	,"group_id" smallint default 0 references security.groups (id)
...
insert into "security"."permissions" (title,alias,section_id,group_id) values
	('View Dashboard','view_dashboard',(select id from security.sections where alias = 'general'),(select id from security.groups where alias = 'dashboard'))
	
	,('List','security_role_list',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'roles'))
	,('Add','security_role_add',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'roles'))
	,('Edit','security_role_edit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'roles'))
	,('Delete','security_role_delete',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'roles'))
	,('Audit','security_role_audit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'roles'))

	,('List','security_section_list',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'sections'))
	,('Add','security_section_add',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'sections'))
	,('Edit','security_section_edit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'sections'))
	,('Delete','security_section_delete',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'sections'))
	,('Audit','security_section_audit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'sections'))

	,('List','security_group_list',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'groups'))
	,('Add','security_group_add',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'groups'))
	,('Edit','security_group_edit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'groups'))
	,('Delete','security_group_delete',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'groups'))
	,('Audit','security_group_audit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'groups'))

	,('List','security_permission_list',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'permissions'))
	,('Add','security_permission_add',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'permissions'))
	,('Edit','security_permission_edit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'permissions'))
	,('Delete','security_permission_delete',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'permissions'))
	,('Audit','security_permission_audit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'permissions'))

	,('List','path_list',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'paths'))
	,('Add','path_add',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'paths'))
	,('Edit','path_edit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'paths'))
	,('Delete','path_delete',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'paths'))
	,('Audit','path_audit',(select id from security.sections where alias = 'administration'),(select id from security.groups where alias = 'paths'))

	,('Report 1','report1',(select id from security.sections where alias = 'reports'),(select id from security.groups where alias = 'reports'))
	,('Report 2','report2',(select id from security.sections where alias = 'reports'),(select id from security.groups where alias = 'reports'))

	,('List','dynamic_content_list',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content'))
	,('Add','dynamic_content_add',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content'))
	,('Edit','dynamic_content_edit',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content'))
	,('Delete','dynamic_content_delete',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content'))
	,('Audit','dynamic_content_audit',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content'))

	,('List','dynamic_content_type_list',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content_types'))
	,('Add','dynamic_content_type_add',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content_types'))
	,('Edit','dynamic_content_type_edit',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content_types'))
	,('Delete','dynamic_content_type_delete',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content_types'))
	,('Audit','dynamic_content_type_audit',(select id from security.sections where alias = 'content'),(select id from security.groups where alias = 'dynamic_content_types'))

	,('List','admin_users_list',(select id from security.sections where alias = 'users'),(select id from security.groups where alias = 'admin_users'))
	,('Add','admin_users_add',(select id from security.sections where alias = 'users'),(select id from security.groups where alias = 'admin_users'))
	,('Edit','admin_users_edit',(select id from security.sections where alias = 'users'),(select id from security.groups where alias = 'admin_users'))
	,('Delete','admin_users_delete',(select id from security.sections where alias = 'users'),(select id from security.groups where alias = 'admin_users'))
	,('Audit','admin_users_audit',(select id from security.sections where alias = 'users'),(select id from security.groups where alias = 'admin_users'))
	,('Permissions','admin_users_permissions',(select id from security.sections where alias = 'users'),(select id from security.groups where alias = 'admin_users'))
...
create table "audits"."public_logins" (
	"id" serial primary key,
	"user_id" int4 not null default '0' references system.users (id),
...
create table "audits"."page_hits" (
	"id" serial primary key,
	"user_id" int default 1 references system.users (id),
...
create table "audits"."security_field_logs" (
	"id" serial primary key,
	"table_log_id" int not null default 0 references audits.security_table_logs (id),
...
create table "audits"."public_field_logs" (
	"id" serial primary key,
	"table_log_id" int not null default 0 references audits.public_table_logs (id),
	"column_name" varchar(64) not null default '',
	"old_value" varchar not null default '',
	"new_value" varchar not null default '',
	"created" timestamp default current_timestamp
...
create table "audits"."system_field_logs" (
	"id" serial primary key,
	"table_log_id" int not null default 0 references audits.system_table_logs (id),
	"column_name" varchar(64) not null default '',
	"old_value" varchar not null default '',
	"new_value" varchar not null default '',
	"created" timestamp default current_timestamp
...
create table "audits"."activity_field_logs" (
	"id" serial primary key,
	"table_log_id" int not null default 0 references audits.activity_table_logs (id),
	"column_name" varchar(64) not null default '',
	"old_value" varchar not null default '',
	"new_value" varchar not null default '',
	"created" timestamp default current_timestamp
...
CREATE TABLE "public"."site_wide_notes" (
	...
	,"active" boolean not null default true
	,"user_id" int not null default 0 references system.users (id)
	,"path_id" int not null default 0 references system.paths (id)
...
/*  Basic Reporting: Audit Information  */
/*  Basic Reporting: User Information  */
...
create table "public"."users" (
	"id" serial primary key
	,"active" boolean not null default true
	,"registration_type_id" smallint default 0 references public.registration_types (id) -- Teacher, Parents, Tutor?
	,"institution_id" smallint default 0 references public.institutions (id)
	,"region_id" smallint default 0 references supplements.regions (id)
	,"country_id" smallint default 0 references supplements.countries (id)
	,"postal_code" varchar(16) default ''
	,"pin" varchar(32) default ''
	,"username" varchar(32) default ''
	,"firstname" varchar(96) not null default ''
	,"lastname" varchar(96) default ''
	,"city" varchar(128) default ''
	,"title" varchar(128) default '' -- Principle, Teacher, Doctor, Rev, etc
	,"company" varchar(128) default '' -- Homeschool info?
	,"email" varchar(192) default ''
	,"password" char(64) default ''
	,"password_salt" bytea default ''
	,"created" timestamp default current_timestamp
 ...
 ***** NEW *****
 * 
 * - User agreements should never be "updated"
 * 		they should only be inactivated and users should store
 * 		which version they agreed to
 */
drop table if exists "public"."legal_agreements" cascade;
CREATE TABLE "public"."legal_agreements" (
	"id" serial primary key
	,"active" boolean default true
	,"required" boolean default false
	,"version" smallint default 1 -- New version of worlds with same potential names?
...
/**
 * Legal Agreement User Map
 *
 ***** NEW *****
 * 
 */
drop table if exists "public"."legal_agreement_user_map" cascade;
CREATE TABLE "public"."legal_agreement_user_map" (
	"id" serial primary key
	,"legal_agreement_id" int not null default 0 references public.legal_agreements (id)
	,"user_id" int not null default 0 references system.users (id)
	,"created" timestamp default current_timestamp
);
 ...
 * 
 */
drop table if exists "supplements"."media_types" cascade;
CREATE TABLE "supplements"."media_types" (
	"id" serial primary key
	,"active" boolean default true
	,"media_group" varchar(16) default ''
	,"alias" varchar(128) default ''
	,"title" varchar(128) not null default ''
	,"description" text default ''
...
insert into "supplements"."media_types" (title,description,alias,details) values
	...
	,('JPEG Image','image/jpeg','jpg','RFC 1314')
	,('JPEG Image','image/jpeg','jpeg','RFC 1314')
	...
	,('Mp3','audio/mp3','mp3','Wikipedia: Mp3')
...
;
UPDATE supplements.media_types SET media_group = substring(description FROM '^[A-Za-z]+');
