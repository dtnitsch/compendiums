...
##################################################
$info = array();
$info = db_fetch("select * from public.compendium where key='". $id ."'",'Getting Compendium');
$q = "
	select
		compendium_list_map.*
		,list.key
	...
	where
		compendium_list_map.compendium_id = '". $info['id'] ."'
";
...
?>
	...
	<h2 class='compendiums'>Edit Compendium: <?php echo $info['title']; ?></h2>
...
?>
		...
		<p>
			<input type="submit" value="Edit Compendium">
		</p>
	</form>
