...
?>
<div class='clearfix'>
	<h2 class='reports'>Report - Schools</h2>
</div>
...
?>
      ...
      <div class='inputs float_left'>
          ...
          <input type="text" name="filters[population]" id="population" value='75'>
      </div>

      <div class='inputs float_left'>
          <label for="registered_count"><b>Minimum Registered</b></label><br>
          <input type="text" name="filters[registered_count]" id="registered_count" value='10'>
      </div>
      ...
      <table id='asl_sort' cellpadding='0' cellspacing='0' class='asl_sort'>
          <thead id='asl_sort_head'>
            <tr>
              ...
              <th data-col='activities_played'>Activities Played</th>
...
<script type="text/javascript">
    ...
    asl_sort.init('/ajax.php',{
        id:'asl_sort'
        ,data: 'apid=a087e2d44806122438bffd6dfc84cbd6'
