...
?>
<div class='clearfix'>
	<h2 class='reports'>Home-School Report</h2>
</div>
      ...
      <table id='asl_sort' cellpadding='0' cellspacing='0' class='asl_sort'>
          <thead id='asl_sort_head'>
            <tr>
              ...
              <th data-col='institution'>Institution Name</th>
              ...
              <th data-col='participating_count'>Participating Count</th>
...
<script type="text/javascript">
    ...
    asl_sort.init('/ajax.php',{
        id:'asl_sort'
        ,data: 'apid=b8a8f168129c48cafb04e25427de010e'
