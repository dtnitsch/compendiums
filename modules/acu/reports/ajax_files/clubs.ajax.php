...
$q = "
	select
		...
		,round(((count(distinct sas.student_id) / (case when pi.active_registration_count = 0 then 1 else pi.active_registration_count end)::numeric) * 100), 2) as participating_percent
	...
	join public.institution_types as tp on
        ...
        and tp.alias in ('after_school','club')
