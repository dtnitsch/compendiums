...
if(!has_access("admin_users_audit")) { back_redirect(); }
...
#   DB Queries
##################################################
$info = db_fetch("select * from system.users where id='". $id ."'",'Getting User');
...
##################################################
?>
    <h2 class='users'>Audit User: <?php echo $info["firstname"]." ".$info["lastname"]; ?></h2>
    
    <div class='content_container'>

    <?= user_navigation($id,"audit") ?>
...
<script type="text/javascript">
    ...
    asl_sort.init('/ajax.php',{
        id:'asl_sort'
        ,data: 'apid=93e7093793b032761370bc46f83e233d&id=<?php echo $id; ?>'
        ,filters: 'filters'
        ,type: "pagination"
    });
