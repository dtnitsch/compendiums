...
if(!has_access('dynamic_content_delete')) { back_redirect(); }
...
##################################################
?>
	<h2 class='dynamic-content'>Delete Dynamic Content: <?php echo $info["title"]; ?></h2>
  
  <div class='content_container'>

	<?= dynamic_content_navigation($id,"delete") ?>
	...
	<div class="delete_box_heading">
	 ...
	 <div class="delete_box">
		...
		<input type="button" onclick="window.location.href='/acu/dynamic-content/'" value="Do Not Delete">
	</div>
